...
The tournament button on the navigation bar will display a tournament, with races being run automatically with the leaderboard changes being displayed after each race. The admin button displays the user details of registered users, excluding passwords (shown below) - this feature was requested by our client. 
\begin{figure}[H]
\centering
