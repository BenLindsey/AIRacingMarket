...
As computer scientists, creating new models isn't really our forte. None of us had any side experience with art either, yet this project required a 3D graphical racing simulation to be shown to the user. Whilst we could probably have developed some assets ourselves if absolutely necessary, upon investigating the Unity assets we found them to be sufficient for our uses, and there were also extra ones available from Unity's Asset Store, which were licensed appropriately for G-Research's needs.
