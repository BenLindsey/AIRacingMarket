...
%Every frame and for each car, the browser front end stores the result of each scripting API function, then executes the car's script using the API results.

% e.g. in tournament mode the application will update the leaderboard.
