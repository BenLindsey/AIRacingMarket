...
We will adopt an agile way of working similar to the Scrum iterative and incremental process (see chart below). Excluding Sprint Zero, we will have two week Sprints, starting on Mondays and ending on Fridays. Our Product Owner\cite{scrumalliance} will be Ed Cresswell from G-Research. We will not have a Scrum Master\cite{scaling} and we will use Trello instead of a physical task board.
